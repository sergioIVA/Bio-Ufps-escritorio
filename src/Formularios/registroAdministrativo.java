 ...
 * @author sergio
 */
public class registroAdministrativo extends javax.swing.JFrame  implements comunJFrame{
    ...
    public registroAdministrativo(registroUsuarios r) {
        initComponents();
         this.setTitle("Registrar Administrativo");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 213, -1, -1));
        getContentPane().add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, 197, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel3.setText("Cedula :");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, -1, 20));
        ...
        getContentPane().add(txtCedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, 194, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel4.setText("Telefono:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, -1, -1));
        getContentPane().add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 330, 197, -1));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setText("Cargo:");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, -1, -1));
        getContentPane().add(txtCargo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, 197, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel7.setText("Correo:");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, -1, -1));
        getContentPane().add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 300, 197, -1));
        ...
        getContentPane().add(imagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(93, 361, 130, 110));
        ...
        getContentPane().add(ingresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 480, -1, -1));

        Administrativo.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        Administrativo.setText("                  SIN FOTO");
        Administrativo.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(Administrativo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, 170, 140));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 166, -1, -1));
   ...
   Usuario usu=new Usuario(cedula,null,huella,nombre,"Administrativo",null,correo,cargo,telefono,foto);
   
        try {
            if(this.r.getMyAsistencia().getMyNegocio().registrarUsuario(usu)){
                JOptionPane.showMessageDialog(null,"¡Se registro Administrativo!");
                ...
                JOptionPane.showMessageDialog(null,"No registro Administrativo");
            }
        } catch (SQLException ex) {
           JOptionPane.showMessageDialog(null,ex.getMessage());
        } catch (IOException ex) {
            Logger.getLogger(registroAdministrativo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void incluirImagen(InputStream f) {
        try {
          ...
          Icon icono=new ImageIcon(I.getScaledInstance(Administrativo.getWidth(),Administrativo.getHeight(),Image.SCALE_DEFAULT));
          this.Administrativo.setIcon(icono);
        } catch (IOException ex) {
